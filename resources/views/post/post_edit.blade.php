    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="number" name="user_id" value="{{ $post->user_id }}" class="form-control" placeholder="user_id">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>img:</strong>
                <input type="file" name="image" value="{{ $post->image }}" class="form-control" placeholder="image">
